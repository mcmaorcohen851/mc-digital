...
(function () {
  ...
  var PROJECTS = [
    ...
    {
      id: "bot-torim",
      name: "בוט וואטסאפ לקביעת תורים למספרות",
      cat: "auto", catLabel: "אוטומציה / וואטסאפ",
      desc: "הלקוחות קובעים תור בוואטסאפ 24/7 והבוט מסנכרן הכול ליומן. תזכורות אוטומטיות, רשימת המתנה שממלאת ביטולים, זיהוי חגים וסגירת יום בלחיצה.",
      tech: ["WhatsApp Business API", "ניהול יומן", "תזכורות אוטומטיות"],
      img: "assets/img/bot-torim/calendar-week.jpg",
      alt: "בוט וואטסאפ לקביעת תורים — יומן ניהול שבועי",
      link: "bot-torim-lemisparot.html"
    },
    {
      id: "sefer-brachot",
      name: "ספר ברכות דיגיטלי לבר/בת מצווה",
      cat: "web", catLabel: "מוצר דיגיטלי",
      desc: "האורחים סורקים QR ומשאירים ברכה בווידאו, תמונה או טקסט מהטלפון — בלי אפליקציה. בסוף מתקבל ספר מזכרת דיגיטלי לדפדוף, PDF לוואטסאפ וקבצים להדפסה.",
      tech: ["QR חכם", "ווידאו מהאורחים", "ספר דיגיטלי אינטראקטיבי"],
      img: "assets/img/sefer-brachot/spread-cover.jpg",
      alt: "ספר ברכות דיגיטלי — עמוד פתיחה עם ברכות אורחים",
